# QuantumVPN Android — главный план архитектуры
...
| Ядро | `sing-box-extended` tag `v1.13.18-extended-2.6.5` |
| Точный commit | `e8f6936480b7fa9738911e3e7fc2ec0d8a634a88` |
...
QuantumVPN — независимый нативный Android-клиент sing-box-extended:
...
- QuantumVPN добавляет собственный package внутренне для health-check и служебных операций через VPN;
...
3. Невыбранное приложение передаёт фиксированный объём — QuantumVPN не должен получать его пакеты или расти по CPU пропорционально трафику.
...
- [QuantumVPN](https://t.me/bypassblock)
...
текущий VPN с runtime-only правилом для package QuantumVPN и доменов GitHub. После запроса
...
- [Pinned core: Android memory/GC policy](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/experimental/libbox/memory.go)
- [Pinned core: status/log command server](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/daemon/started_service.go)
- [Pinned core: internal Clash API creation from PlatformLogWriter](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/box.go)
- [Pinned core: traffic manager](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/experimental/clashapi/trafficontrol/manager.go)
