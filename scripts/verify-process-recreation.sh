...
COMPONENT="$PACKAGE/com.quantumvpn.debug.Gate6ProcessProbeReceiver"
...
cleanup() {
    $ADB shell am start -W -n "$PACKAGE/com.quantumvpn.MainActivity" >/dev/null 2>&1 || true
    probe "com.quantumvpn.debug.GATE6_CLEANUP" >/dev/null 2>&1 || true
...
first="$(probe "com.quantumvpn.debug.GATE6_SETUP")"
...
after_death="$(probe "com.quantumvpn.debug.GATE6_STATUS")"
...
second="$(probe "com.quantumvpn.debug.GATE6_SETUP")"
