...
import com.quantumvpn.vpn.VpnRuntimeMetrics
import com.quantumvpn.vpn.VpnTestHooks
import java.io.File
...
class Gate8StressProbeReceiver : BroadcastReceiver() {
    ...
    private suspend fun prepare(container: com.quantumvpn.AppContainer): String {
        cleanup(container)
    ...
    private suspend fun connect(container: com.quantumvpn.AppContainer): String {
    ...
    private fun armRestart(container: com.quantumvpn.AppContainer): String {
    ...
    private suspend fun stop(container: com.quantumvpn.AppContainer): String {
    ...
    private suspend fun cleanup(container: com.quantumvpn.AppContainer): String {
        stop(container)
        container.profileStore.initialize()
    ...
    private fun status(container: com.quantumvpn.AppContainer): String {
        val snapshot = VpnRuntimeMetrics.snapshot()
    ...
    companion object {
        const val ACTION_PREPARE = "com.quantumvpn.debug.GATE8_PREPARE"
        const val ACTION_CONNECT = "com.quantumvpn.debug.GATE8_CONNECT"
        const val ACTION_ARM_RESTART = "com.quantumvpn.debug.GATE8_ARM_RESTART"
        const val ACTION_STOP = "com.quantumvpn.debug.GATE8_STOP"
        const val ACTION_STATUS = "com.quantumvpn.debug.GATE8_STATUS"
        const val ACTION_CLEANUP = "com.quantumvpn.debug.GATE8_CLEANUP"
