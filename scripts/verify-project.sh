...
expected = [
    ...
    ("app/src/main/java/io/github/zapretkvn/android/vpn/QuantumVpnService.kt", 1),
...
python3 - "$PROJECT_ROOT" "$CORE_COMMIT" <<'PY'
from pathlib import Path
import hashlib
import json
import sys
...
if manifest.get("generated_with_core") != sys.argv[2]:
