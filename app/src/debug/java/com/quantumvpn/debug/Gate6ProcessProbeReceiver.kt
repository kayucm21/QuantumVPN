...
class Gate6ProcessProbeReceiver : BroadcastReceiver() {
    ...
    private suspend fun setup(container: com.quantumvpn.AppContainer): String {
        cleanup(container)
    ...
    companion object {
        const val ACTION_SETUP = "com.quantumvpn.debug.GATE6_SETUP"
        const val ACTION_STATUS = "com.quantumvpn.debug.GATE6_STATUS"
        const val ACTION_CLEANUP = "com.quantumvpn.debug.GATE6_CLEANUP"
