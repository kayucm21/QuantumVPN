# ADR-003: приложения, назначения и rule-set в QuantumVPN
...
- [точный core: отказ legacy GeoIP/Geosite](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/route/rule/rule_default.go#L128-L136)
- [точный core: inline/local/remote rule-set](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/option/rule_set.go)
- [точный core: Android platform TUN не разворачивает route address set](https://github.com/shtorm-7/sing-box-extended/blob/e8f6936480b7fa9738911e3e7fc2ec0d8a634a88/protocol/tun/inbound.go#L297-L355)
